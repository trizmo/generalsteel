...
class Header extends Component {
    ...
    render() {
        ...
        let logoUrl;
        if (logo === 'light') {
            logoUrl = <img src="/assets/images/logo/logo-light.png" alt="General Steel Supply" />;
        } else if (logo === 'dark') {
            logoUrl = <img src="/assets/images/logo/logo-dark.png" alt="General Steel Supply" />;
        } else if (logo === 'symbol-dark') {
            logoUrl = <img src="/assets/images/logo/logo-symbol-dark.png" alt="General Steel Supply" />;
        } else if (logo === 'symbol-light') {
            logoUrl = <img src="/assets/images/logo/logo-symbol-light.png" alt="General Steel Supply" />;
        } else {
            logoUrl = <img src="/assets/images/logo/logo.png" alt="General Steel Supply" />;
        }
        return (
                            ...
                            <ul className="mainmenu">
                                <li className="has-droupdown"><Link to="#">Home</Link>
                                    <ul className="submenu">
                                        ...
                                        <li><Link to="/digital-agency">General Steel Supply</Link></li>
