...
const singleDemo = [
...

    {
        ...
        description: 'Added creative agency landing page.When you need creative agency landing page you can be use it for your creative agency, General Steel Supply landing page page.',
        label: ''
    },
    ...
    },
    {
        ...
        description: 'Home particle has most feature is particles animation.It can be used for your creative agency, Business agency, General Steel Supply and so on, And it has Landing page added.',
        label: ''
    },
...

    {
        ...
        title: 'General Steel Supply',
        description: 'A General Steel Supply template is a nice slider animation, faster loading and all features available for agencies.',
        label: ''
    },
    {
        url: 'business',
